...
class Solution:
    ...
    def getExtrapolated(self, inputarr):
        ...
        for i,subarr in enumerate(stack):
            n = 0 if i == 0 else subarr[0] - newarr[i-1][0]
            subarr = [n, *subarr]
            newarr.append(subarr)


        extrapolated=newarr[-1][0]
        return extrapolated
...
t = Solution()
# print(t.getExtrapolated([0, 3, 6, 9, 12, 15]))
# print(t.getExtrapolated([1, 3, 6, 10, 15, 21]))
# print(t.getExtrapolated([10, 13, 16 ,21, 30, 45]))
print(t.sensorReading(prod=True))
